...
//		double generatorType = (Double)p.getValue("generatorType");
		...
		double eCostGrid = (Double)p.getValue("eCostGridHighEcon1");
		double eCostOther = (Double)p.getValue("eCostOtherHighEcon1");
		double carbonOutputGrid = (Double)p.getValue("carbonOutGridHighEcon1");
    ...
    */
	...
	public static double getEnergyCost(double avgDemand, String eSource){
		...
		double eCostGrid = (Double)p.getValue("eCostGridHighEcon" + tickCount);
		double eCostOther = (Double)p.getValue("eCostOtherHighEcon" + tickCount);
		String grid = "grid";
		String other = "other";
...
//			System.out.println("Energy Cost other is " + energyCost);
	...
	public static double getCO2Output(double avgDemand, String eSource){
		Parameters p = RunEnvironment.getInstance().getParameters();
		int tickCount = (int) RunEnvironment.getInstance().getCurrentSchedule().getTickCount(); // gets the tickCount and casts it to an integer
		double carbonOutputGrid = (Double)p.getValue("carbonOutGridHighEcon" + tickCount);
